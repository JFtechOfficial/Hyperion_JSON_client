...
Client module for the Hyperion JSON interface. You can also read this in [Italiano🇮🇹](https://github.com/JFtechOfficial/hyperion-client/blob/master/README-it-IT.md)
